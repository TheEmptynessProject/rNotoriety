...
function library:CreateWindow(name)
    ...
    local function JJAV_fake_script() -- Background.Toggle
    ...
    local function FCVY_fake_script() -- Background.Draggable
        local script = Instance.new("LocalScript", Background)
    ...
    local function YOSQZU_fake_script() -- DeleteGui.DeleteGui-HoverColor
    ...
    local function PTMQ_fake_script() -- HideGui.HideGui-HoverColor
    ...
    local function JDKM_fake_script() -- ImpostorGui.PageScript
...
library:Button(
    ...
    function()
        ...
        local Holding = false
        local keyRun = Enum.UserInputType.MouseButton2
        ...
        UIS.InputBegan:Connect(
            function(input, processed)
                ...
                if input.UserInputType == keyRun then
                    Holding = true
            ...
            function()
                if Holding == true and _G.AimbotEnabled == true then
                    TweenService:Create(
                        ...
                        {CFrame = CFrame.new(Camera.CFrame.Position, GetClosestPlayer()[_G.AimPart].Position)}
                    ):Play()
                end
            end
        )
...
library:Button(
    ...
    function()
		...
		if v:FindFirstChild('Head') then
            ...
            game:GetService("ReplicatedStorage").RS_Package.Assets.Remotes.Damage:FireServer(unpack(args))
...
library:Button( --not working, will prob update
"Loop Kill Police",
function()
            ...
            function()
                ...
                for i, v in pairs(game.Workspace.Citizens:GetChildren()) do
                    if v.Name == "CitizenScared" then
                        ...
                        game:GetService("ReplicatedStorage").RS_Package.Remotes.PlayerYell:FireServer(unpack(args))
                    end
                end
            end
        )
...
for i = 0, 256, 1 do --anti dumper... kinda?
